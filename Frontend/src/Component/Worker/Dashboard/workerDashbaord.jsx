...
//         <div className="bg-blue-50 rounded-lg p-6 mb-6 flex flex-col sm:flex-row justify-between items-center text-center sm:text-left">
//           <div>
//             <h1 className="text-xl sm:text-2xl font-bold text-gray-800">Good Afternoon</h1>
...
//             <p className="text-gray-500 mb-1">Completed Orders</p>
//             <p className="text-3xl font-bold">2</p>
//           </div>
//           <div className="bg-white rounded-lg p-4 border-l-4 border-yellow-500 shadow-sm">
//             <p className="text-gray-500 mb-1">Pending Orders</p>
//             <p className="text-3xl font-bold">2</p>
//           </div>
...
//             <p className="text-3xl font-bold">50<span className="text-gray-400 text-xl">%</span></p>
//           </div>
//         </div>
